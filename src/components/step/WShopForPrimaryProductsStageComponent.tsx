...
import { SelectMainProductCategoryCount } from '../../app/store';
...
export function WShopForPrimaryProductsStage({ categoryId, ProductsForCategoryFilteredAndSorted, onProductSelection, hidden }: WShopForProductsStageProps) {
